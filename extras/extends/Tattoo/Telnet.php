 ...
 * @version $Id: Telnet.php 2050 2015-09-01 12:13:25Z alacner $
 */
...
class Tattoo_Telnet
{
	 ...
	 */
	public function linefeeds($opt = null) {
		if ($opt !== null)
	 ...
	 */
	public function page_prompt($p = null,$c = null) {
		if ($p !== null)
			$this->page_prompt = $p;
		if ($c !== null)
	 ...
	 */
	public function echomode ($mode = null) {
		switch ($mode)
		{
			case "local":
	 ...
	 */
	public function connect($opts=null) {
	 ...
	 */
	public function net_write ($data=null) {
		$written=0;
		$n=0;
	 ...
	 */
	public function initial_options() {
	 ...
	 */
	public function send_telcmd($cmd=TEL_NOP, $opt=null, $data=null) {
	 ...
	 */
	public function recv_telcmd($cmd=TEL_NOP, $opt=null, $data=null) {
		global $TELCMDS, $TELOPTS;
		if (! TELCMD_OK($cmd))
			throw new Exception("unknown TELNET command: ".ord($cmd));
	 ...
	 */
	public function get_data ($cnt=0) {
		if ((intval($cnt) == 0) ||
	 ...
	 */
	public function put_data ($data, $esc=true, $echo=true) {
	 ...
	 */
	public function waitfor($arg=null) {
		if ($arg == null)
			$arg = $this->prompt;
	 ...
	 */
	public function expect ($arg,$arg2=null) {
	 ...
	 */
	public function send ($data=null, $esc=true, $echo=true) {
	 ...
	 */
	public function read_stream($searchfor=null, $numbytes=null, $timeout=null) {
		global $TELCMDS, $TELOPTS;
	 ...
	 * @todo: document $args
	 */
	public function login($args=null,$arg2=null) {
		if (is_string($args)) {
